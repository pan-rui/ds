...
//    }
    ...
    private SBlock bytesToBlock(byte buffer[], int nPos) {
        SBlock b = new SBlock();
        b.m_Hi = (buffer[nPos] & 0xFF) << 24 | (buffer[nPos + 1] & 0xFF) << 16 | (buffer[nPos + 2] & 0xFF) << 8 | (buffer[nPos + 3] & 0xFF);
        b.m_Lo = (buffer[nPos + 4] & 0xFF) << 24 | (buffer[nPos + 5] & 0xFF) << 16 | (buffer[nPos + 6] & 0xFF) << 8 | (buffer[nPos + 7] & 0xFF);
        return b;
    }
...
/*    *//**
    ...
    public static void main(String[] args) {
        //BlowfishECB bf = new BlowfishECB(hex2byte("0170F175468FB5E6"));
        Blowfish bf = new Blowfish("0000234e");
        bf.setKey("linklink_private_key_)@^");
//        long startTime = System.currentTimeMillis();
//        String encrypted = bf.encrypt("15019475599|1234aaa我的中文！@#@%&*&（*）——+&……%%￥56|15019475599|192.168.0.126|1429958756925");
//        System.out.println(encrypted);
        System.out.println(bf.decrypt("52386D4DA675A530BC5B327DE7A0C55CA98B1A4C0F078836E33400BE387DBA09938C613EF842854E61D50A07A74BC506"));
//        System.out.println(bf.decrypt("93EBF92D035DF5C853565A1E6DF7A42EDE6ADEE0E1FD025FB4620BC14837F577C7D3ACE630FFBEE52D4E8CB6F87709F885C3C9B1B4EC2DD2AEF40DF24478F890405140EF0D02AF2782EB5CEED2E6105533E5603B2A110C249EF9619F6F0497E5"));
//        long endTime = System.currentTimeMillis();
//        System.out.println("程序运行时间： " + (endTime - startTime) + "ms");
//        System.out.println("---" + (System.currentTimeMillis() - 1430143472014l));
//        System.out.println("---- " + new Date(1430143472014L));
    }*/
}
