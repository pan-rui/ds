...
public class TenantPrivilegesController extends BaseController {

@Autowired
private BaseService baseService;
    private String tableN=TableConstants.TENANT_PRIVILEGES;
	 ...
	 * @return
	 */
	@RequestMapping("/tenantPrivileges/add")
	@ResponseBody
...
//        urlFilterService.addFuncPermiss(map, ddBB);
	 ...
	 * @return
	 */
	@RequestMapping("/tenantPrivileges/delete")
	@ResponseBody
...
//        boolean b = urlFilterService.deleteFuncPermiss(map, ddBB) > 0;
	 ...
	 * @return
	 */
	@RequestMapping("/tenantPrivileges/edit")
	@ResponseBody
...
//        boolean b = urlFilterService.updateFuncPermiss(map, ddBB) > 0;
	 ...
	 * @return
	 */
	@RequestMapping("/tenantPrivileges/get")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping("/tenantPrivileges/getList")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping("/tenantPrivileges/getPage")
	@ResponseBody
