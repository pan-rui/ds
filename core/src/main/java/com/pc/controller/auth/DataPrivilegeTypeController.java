...
public class DataPrivilegeTypeController extends BaseController {
	@Autowired
	private DataPrivilegeTypeService dataPrivilegeTypeService;

	private Logger logger = LogManager.getLogger(this.getClass());
	
	@RequestMapping("/dataPrivilegeType/add")
	@ResponseBody
	public BaseResult add(@RequestAttribute(Constants.USER_ID) String userId,
		...
		dataPrivilegeTypeService.addDataPrivilegeType(map, ddBB);
		return new BaseResult(ReturnCode.OK);
	}

	@RequestMapping("/dataPrivilegeType/delete")
	@ResponseBody
	public BaseResult delete(@RequestAttribute(Constants.USER_ID) String userId, @EncryptProcess ParamsVo params,
		...
		boolean b = dataPrivilegeTypeService.deleteDataPrivilegeType(map, ddBB);
		if (b) {
			return new BaseResult(ReturnCode.OK);
		} else {
	...
	@RequestMapping("/dataPrivilegeType/edit")
	@ResponseBody
	public BaseResult edit(@EncryptProcess ParamsVo params, @RequestAttribute(Constants.USER_ID) String userId,
		...
		map.put(TableConstants.UPDATE_TIME, DateUtil.convertDateTimeToString(new Date(), null));
		map.put(TableConstants.UPDATE_USER_ID, userId);
		boolean b = dataPrivilegeTypeService.updateDataPrivilegeType(map, ddBB);
		if (b) {
			return new BaseResult(ReturnCode.OK);
		} else {
			return new BaseResult(ReturnCode.FAIL);
	...
	@RequestMapping("/dataPrivilegeType/get")
	@ResponseBody
	public BaseResult get(@EncryptProcess ParamsVo params, @RequestAttribute String ddBB) {
		Map<String, Object> map = new LinkedHashMap<>(params.getParams());
		return new BaseResult(ReturnCode.OK, dataPrivilegeTypeService.getDataPrivilegeType(map, ddBB));
	}

	@RequestMapping("/dataPrivilegeType/getList")
	@ResponseBody
	...
	@RequestMapping("/dataPrivilegeType/getPage")
	@ResponseBody
