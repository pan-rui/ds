...
import com.pc.service.project.impl.HouseholdTypeService;
...
public class HouseholdTypeController extends BaseController {
	@Autowired
	private HouseholdTypeService householdTypeService;

	private Logger logger = LogManager.getLogger(this.getClass());
	
	@RequestMapping("/householdType/add")
	@ResponseBody
	public BaseResult add(@RequestAttribute(Constants.USER_ID) String userId,
		...
		householdTypeService.addHouseholdType(map, ddBB);
		return new BaseResult(ReturnCode.OK);
	}

	@RequestMapping("/householdType/delete")
	@ResponseBody
	public BaseResult delete(@RequestAttribute(Constants.USER_ID) String userId, @EncryptProcess ParamsVo params,
		...
		boolean b = householdTypeService.deleteHouseholdType(map, ddBB);
		if (b) {
			return new BaseResult(ReturnCode.OK);
		} else {
	...
	@RequestMapping("/householdType/edit")
	@ResponseBody
	public BaseResult edit(@EncryptProcess ParamsVo params, @RequestAttribute(Constants.USER_ID) String userId,
		...
		map.put(TableConstants.UPDATE_TIME, DateUtil.convertDateTimeToString(new Date(), null));
		map.put(TableConstants.UPDATE_USER_ID, userId);
		boolean b = householdTypeService.updateHouseholdType(map, ddBB);
		if (b) {
			return new BaseResult(ReturnCode.OK);
		} else {
			return new BaseResult(ReturnCode.FAIL);
	...
	@RequestMapping("/householdType/get")
	@ResponseBody
	public BaseResult get(@EncryptProcess ParamsVo params, @RequestAttribute String ddBB) {
		Map<String, Object> map = new LinkedHashMap<>(params.getParams());
		return new BaseResult(ReturnCode.OK, householdTypeService.getHouseholdType(map, ddBB));
	}

	@RequestMapping("/householdType/getList")
	@ResponseBody
	public BaseResult getList(@EncryptProcess ParamsVo params, @RequestAttribute String ddBB) {
		Map<String, Object> map = new LinkedHashMap<>(params.getParams());
		return new BaseResult(ReturnCode.OK, householdTypeService.getHouseholdTypeList(map, ddBB));
	}

	@RequestMapping("/householdType/getPage")
	@ResponseBody
