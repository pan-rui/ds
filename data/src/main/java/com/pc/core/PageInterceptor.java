...
//            sql = sql.substring(0,sql.length() - 3);
    ...
    public String processStr(String str,String prefix) {
        return prefix + str.replace(TableConstants.SEPARATE_SPLIT,  TableConstants.SEPARATE_SPLIT+prefix);
    }

    public String processS(String str, String prefix, String suffix) {
//        return prefix + str.replace(TableConstants.SEPARATE_SPLIT, suffix + TableConstants.SEPARATE_SPLIT + prefix) + suffix;
