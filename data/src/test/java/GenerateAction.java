...
//        String jdbcUrl = "jdbc:mysql://120.25.65.82:3306/"+schema+"?useUnicode=true&characterEncoding=UTF-8";
        String jdbcUrl = "jdbc:mysql://172.16.12.151:3306/"+schema+"?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
        String userId="root";
        String password = "pcjz123456~";
        GenerateAction generateAction = new GenerateAction("dems","com.pc.controller.curd", "F:\\workspace\\DEMS\\data\\src\\test\\java\\com\\pc\\core\\","com.pc.core");//TODO:可指定单个Table
      // generateAction.tableName="USER";      //单表情况
        ...
        sbTab.append("public class TableConstants {\n");
        ...
        File tbFile=new File(generateAction.actionPath+"TableConstants.java");
...
//                ResultSet tableRs = metaData.getTables(conn.getCatalog(), "root", table, new String[]{"TABLE"});
                ResultSet tableRs = metaData.getColumns(conn.getCatalog(), "dems", table, "");
...
//            System.out.println(sbTab.toString());
    ...
    public String addMethod(String tableName, String tableAlias) {
        ...
        sb.append("    public BaseResult " + methodName + "(@EncryptProcess ParamsVo pv, @RequestHeader(Constants.TENANT_ID) String tenantId,@RequestAttribute String ddBB) {\n" +
                ...
                "        baseService.add(pv.getParams(), ddBB + TableConstants.SEPARATE + TableConstants." + tableName + ");\n" +
    ...
    public String updateMethod(String tableName, String tableAlias) {
        ...
        sb.append("    public BaseResult " + methodName + "(@EncryptProcess ParamsVo pv, @RequestAttribute(Constants.USER_ID) String userId,@RequestAttribute String ddBB) {\n" +
                ...
                "        int result=baseService.update(pv.getParams(), ddBB + TableConstants.SEPARATE + TableConstants." + tableName + ");\n" +
    ...
    public String queryMethod(String tableName, String tableAlias) {
        ...
        sb.append("    @RequestMapping(value = \"" + tableAlias + "\", method = RequestMethod.GET)\n" +
                "    @ResponseBody");
        sb.append("    public BaseResult " + methodName + "(@EncryptProcess ParamsVo pv, @RequestAttribute(Constants.USER_ID) String userId,@RequestAttribute String ddBB) {\n" +
                "        return new BaseResult(0,baseService.queryList(pv.getParams(),null,ddBB + TableConstants.SEPARATE + TableConstants." + tableName + "));\n" +
                "    }").append("\n");
        return sb.toString();
    }
}
